...
from authemail.models import SignupCode, PasswordResetCode, EmailChangeCode,ChangeOrgCode
...
class ChangeOrgCodeAdmin(admin.ModelAdmin):
    list_display = ('code', 'user', 'ipaddr', 'created_at','organization','org_is_admin',)
    ordering = ('-created_at',)
    readonly_fields = ('user', 'code', 'ipaddr','organization','org_is_admin')
...
admin.site.register(ChangeOrgCode, ChangeOrgCodeAdmin)